...
function showArrows(index, arrows) {
  ...
  if (playerArrows[index].body.position.y > height || playerArrows[index].body.position.x < 0 || playerArrows[index].body.position.x > width){
    World.remove(world, playerArrows[index].body);
